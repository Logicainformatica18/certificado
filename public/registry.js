...
function registryEdit(id) {
    ...
    axios({
        ...
        .then(function (response) {
           ...
           //alert(response.data["date_certification"]);
           //registry.date_certification.value = response.data["date_certification"];
            registry.date_certification.value = response.data[
                "date_certification"
            ].substr(0, 10);
            registry.teacher.value =
                response.data["teacher_m"] +
                "-" +
                response.data["teacher_t"] +
                "-" +
                response.data["teacher_r"];
