...
@section('content')
                        ...
                        <button type="button"style="border-radius:20px;background-color:#3a260c;color:white" class="btn" data-toggle="modal"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer"style="font-family:Montserrat-Bold">
                                            <input type="button" value="Nuevo" class="btn" style="font-family:Montserrat-SemiBold;background-color:#3a260c;color:#ffffff"
