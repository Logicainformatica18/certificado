                        ...
                        <form action="" method="post" role="form" id="exam" name="exam">
                             ...
                             <div class="container align-content-center">
                                <div class="form-group row">
                                    ...
                                    <div class="btn btn-default btn-file col-9">
                                        ...
                                        <input type='file' id="imgInp" name="question_image" onchange="readImage(this,'#blah1');">
                                    </div>
                                ...
                                <div class="size-100">
                                    <br>
                                    <img id="blah1" name="fotografia" src="https://via.placeholder.com/150" alt="Tu imagen"
                            ...
                            Alternativa 1 : <input type="text" name="alternative1" id="alternative1" class="form-control">
                              <div class="container align-content-center">
                                <div class="form-group row">
                                    ...
                                    <div class="btn btn-default btn-file col-9">
                                        <i class="fas fa-paperclip"></i> Subir
                                        <input type='file' id="imgInp" name="image1" onchange="readImage(this,'#blah2');">
                                    </div>
                                ...
                                <div class="size-100">
                                    <br>
                                    <img id="blah2" name="fotografia" src="https://via.placeholder.com/150" alt="Tu imagen"
                                        class="img-bordered" width="40%">
                                </div>
                            </div>
                            Alternativa 2 : <input type="text" name="alternative2" id="alternative2" class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="btn btn-default btn-file col-9">
                                        <i class="fas fa-paperclip"></i> Subir
                                        <input type='file' id="imgInp" name="image2" onchange="readImage(this,'#blah3');">
                                    </div>
                                ...
                                <div class="size-100">
                                    <br>
                                    <img id="blah3" name="fotografia" src="https://via.placeholder.com/150" alt="Tu imagen"
                                        class="img-bordered" width="40%">
                                </div>
                            </div>
                            Alternativa 3 : <input type="text" name="alternative3" id="alternative3" class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="btn btn-default btn-file col-9">
                                        <i class="fas fa-paperclip"></i> Subir
                                        <input type='file' id="imgInp" name="image3" onchange="readImage(this,'#blah4');">
                                    </div>
                                ...
                                <div class="size-100">
                                    <br>
                                    <img id="blah4" name="fotografia" src="https://via.placeholder.com/150" alt="Tu imagen"
                                        class="img-bordered" width="40%">
                                </div>
                            </div>
                            Alternativa 4 : <input type="text" name="alternative4" id="alternative4" class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="btn btn-default btn-file col-9">
                                        <i class="fas fa-paperclip"></i> Subir
                                        <input type='file' id="imgInp" name="image4" onchange="readImage(this,'#blah5');">
                                    </div>
                                ...
                                <div class="size-100">
                                    <br>
                                    <img id="blah5" name="fotografia" src="https://via.placeholder.com/150" alt="Tu imagen"
                                        class="img-bordered" width="40%">
                                </div>
                            </div>
                            Corecto :
