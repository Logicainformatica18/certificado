                        ...
                        <div style="width: 15rem;border-radius:40px" class="card">
                            ...
                            color:white">
                                <h5 class="card-title"style="font-family:Montserrat-Bold;
                                 font-size:30px" ;>{{ $registry_details->registry->course->description }} </h5>
                                ...
                                @role('Estudiante')
                                <a class="btn btn-sm" style="border-radius:15px;color:black;background-color: #ffe921"
                                        onclick="topic('{{ $registry_details->registry->course->id }}')">
                                        Contenido</a> 
                                        <p></p>
