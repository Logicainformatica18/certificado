                            ...
                            <ul class="mini-nav-ul" data-simplebar>
                                ...
                                <li class="mini-nav-item" id="mini-4">
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip"
                                        data-bs-custom-class="custom-tooltip" data-bs-placement="right"
                                        data-bs-title="Forms">
                                        <iconify-icon icon="solar:palette-round-line-duotone"
                                            class="fs-7"></iconify-icon>
                                    </a>
                                </li>
                                ...
                                <li class="mini-nav-item" id="mini-10">
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip"
                                        ...
                                        <iconify-icon icon="solar:mirror-left-line-duotone"
                                            class="fs-7"></iconify-icon>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="sidebarmenu">
                            ...
                            <nav class="sidebar-nav" id="menu-right-mini-1" data-simplebar>
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="{{ asset('template_premium/main/index.html') }}"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/index2.html') }}"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/index3.html') }}"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link"
                                                    href="{{ asset('template_premium/main/eco-shop.html') }}">
                                                    <span class="icon-small"></span> Shop
                                                </a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link"
                                                    href="{{ asset('template_premium/main/eco-shop-detail.html') }}">
                                                    <span class="icon-small"></span>Details
                                                </a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link"
                                                    href="{{ asset('template_premium/main/eco-product-list.html') }}">
                                                    <span class="icon-small"></span>List
                                                </a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link"
                                                    href="{{ asset('template_premium/main/eco-checkout.html') }}">
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link"
                                                    href="{{ asset('template_premium/main/blog-posts.html') }}">
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link"
                                                    href="{{ asset('template_premium/main/blog-detail.html') }}">
                                                    <span class="icon-small"></span>Blog
                                                    Detailsww
                                                </a>
                                            </li>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/page-user-profile.html') }}"
                                            aria-expanded="false">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-email.html') }}"><iconify-icon
                                                icon="solar:letter-line-duotone"></iconify-icon>Email</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-calendar.html') }}"><iconify-icon
                                                icon="solar:calendar-mark-line-duotone"></iconify-icon>Calendar</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-kanban.html') }}"><iconify-icon
                                                icon="solar:airbuds-case-minimalistic-line-duotone"></iconify-icon>Kanban</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-chat.html') }}"><iconify-icon
                                                icon="solar:chat-round-line-line-duotone"></iconify-icon>Chat</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-notes.html') }}"><iconify-icon
                                                icon="solar:document-text-line-duotone"></iconify-icon>Notes</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-contact.html') }}"><iconify-icon
                                                icon="solar:iphone-line-duotone"></iconify-icon>Contact Table</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-contact2.html') }}"><iconify-icon
                                                icon="solar:phone-line-duotone"></iconify-icon>Contact List</a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/app-invoice.html') }}"><iconify-icon
                            ...
                            <nav class="sidebar-nav scroll-sidebar" id="menu-right-mini-3" data-simplebar>
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/landingpage/index.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/pages-animation.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/pages-search-result.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/pages-gallery.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/pages-treeview.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/pages-block-ui.html') }}"
                                            class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:quit-full-screen-square-line-duotone"></iconify-icon>
                                            <span class="hide-menu">Block-Ui</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/pages-session-timeout.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/page-pricing.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/page-faq.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/page-account-settings.html') }}"
                                            class="sidebar-link">
                                            <iconify-icon
                                    ...
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/starter.html') }}"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link"
                                            href="{{ asset('template_premium/main/icon-tabler.html') }}"
                                            aria-expanded="false">
                                            <iconify-icon
                                                icon="solar:sticker-smile-circle-2-line-duotone"></iconify-icon>
                                            <span class="hide-menu">Tabler Icon</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link"
                                            href="{{ asset('template_premium/main/icon-solar.html') }}"
                                            aria-expanded="false">
                                            <iconify-icon
                                                icon="solar:sticker-smile-circle-2-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/widgets-cards.html') }}">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/widgets-banners.html') }}">
                                            <iconify-icon
                                                icon="solar:align-vertical-spacing-line-duotone"></iconify-icon>
                                            <span class="hide-menu">Banner</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/widgets-charts.html') }}">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/widgets-feeds.html') }}">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/widgets-apps.html') }}">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link"
                                            href="{{ asset('template_premium/main/widgets-data.html') }}">
                                ...
                                <div>
                                    <ul class="sidebar-menu" id="sidebarnav">
                                        ...
                                        <li class="sidebar-item">
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-inputs.html') }}"
                                                        class="sidebar-link">
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-input-groups.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-input-grid.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-checkbox-radio.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-bootstrap-switch.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-select2.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                        ...
                                        <li class="sidebar-item">
                                            <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                                aria-expanded="false">
                                                <iconify-icon
                                                    icon="solar:password-minimalistic-input-line-duotone"></iconify-icon>
                                                <span class="hide-menu">Forms Inputs</span>
                                            </a>
                                            <ul aria-expanded="false" class="collapse first-level">
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-basic.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-vertical.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-horizontal.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-actions.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-row-separator.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-bordered.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-detail.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-striped-row.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                                ...
                                                <li class="sidebar-item">
                                                    <a href="{{ asset('template_premium/main/form-floating-input.html') }}"
                                                        class="sidebar-link">
                                                        <span class="icon-small"></span>
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-wizard.html') }}"
                                                class="sidebar-link">
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-repeater.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon
                                                    icon="solar:repeat-one-minimalistic-bold-duotone"></iconify-icon>
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-dropzone.html') }}"
                                                class="sidebar-link">
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-mask.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon icon="solar:mask-happly-line-duotone"></iconify-icon>
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-typeahead.html') }}"
                                                class="sidebar-link">
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-bootstrap-validation.html') }}"
                                                class="sidebar-link">
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-custom-validation.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon icon="solar:shield-warning-line-duotone"></iconify-icon>
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-picker-colorpicker.html') }}"
                                                class="sidebar-link">
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-picker-bootstrap-rangepicker.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon
                                                    icon="solar:square-transfer-horizontal-line-duotone"></iconify-icon>
                                                <span class="hide-menu">Rangepicker</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-picker-bootstrap-datepicker.html') }}"
                                                class="sidebar-link">
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-picker-material-datepicker.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon
                                                    icon="solar:smartphone-update-line-duotone"></iconify-icon>
                                        ...
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-editor-quill.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon
                                                    icon="solar:clapperboard-edit-line-duotone"></iconify-icon>
                                                <span class="hide-menu">Quill Editor</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-item">
                                            <a href="{{ asset('template_premium/main/form-editor-tinymce.html') }}"
                                                class="sidebar-link">
                                                <iconify-icon
                                                    icon="solar:clapperboard-edit-line-duotone"></iconify-icon>
                            ...
                            <nav class="sidebar-nav scroll-sidebar" id="menu-right-mini-5" data-simplebar>
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/table-layout-coloured.html"
                                            class="sidebar-link">
                                            <iconify-icon icon="solar:tablet-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/table-datatable-basic.html"
                                            class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:align-horizonta-spacing-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/table-datatable-advanced.html"
                                            class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:align-horizonta-spacing-line-duotone"></iconify-icon>
                                ...
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/ui-buttons.html" class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:airbuds-case-minimalistic-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/ui-breadcrumb.html" class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:slider-minimalistic-horizontal-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/ui-scrollspy.html" class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:multiple-forward-right-line-duotone"></iconify-icon>
                            ...
                            <nav class="sidebar-nav scroll-sidebar" id="menu-right-mini-8" data-simplebar>
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/component-sweetalert.html"
                                            class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:star-fall-minimalistic-2-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/component-nestable.html" class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:speaker-minimalistic-line-duotone"></iconify-icon>
                                            <span class="hide-menu">Nestable</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/component-noui-slider.html"
                                            class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:watch-square-minimalistic-charge-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/component-toastr.html" class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:station-minimalistic-bold-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/ui-card-weather.html" class="sidebar-link">
                                            <iconify-icon
                                                icon="solar:cloud-snowfall-minimalistic-line-duotone"></iconify-icon>
                            ...
                            <nav class="sidebar-nav scroll-sidebar" id="menu-right-mini-9" data-simplebar>
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-error.html"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-login.html"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-login2.html"
                                            class="sidebar-link">
                                            <iconify-icon icon="solar:login-3-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-register.html"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-register2.html"
                                            class="sidebar-link">
                                            <iconify-icon icon="solar:user-plus-rounded-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-forgot-password.html"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-forgot-password2.html"
                                            class="sidebar-link">
                                            <iconify-icon icon="solar:password-outline"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-two-steps.html"
                                            class="sidebar-link">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-two-steps2.html"
                                            class="sidebar-link">
                                            <iconify-icon icon="solar:siderbar-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/authentication-maintenance.html"
                                            class="sidebar-link">
                ...
                <div class="with-vertical"><!-- ---------------------------------- -->
                    ...
                    <nav class="navbar navbar-expand-lg p-0">
                        ...
                        <div class="d-block d-lg-none py-9 py-xl-0">
                            <img src="{{ asset('template_premium/assets/images/logos/logo.svg') }}"
                                alt="matdash-img" />
                        </div>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="javascript:void(0)" id="drop1"
                                            ...
                                            <div class="d-flex align-items-center gap-2 lh-base">
                                                @if (Auth::user()->sex == 'M')
                                                    <img src="{{ asset('template_premium/assets/images/profile/user-1.jpg') }}"
                                                        class="rounded-circle" width="35" height="35"
                                                        alt="matdash-img" />
                                                @else
                                                    <img src="{{ asset('template_premium/assets/images/profile/user-2.jpg') }}"
                                                        class="rounded-circle" width="35" height="35"
                                                        alt="matdash-img" />
                                                @endif
                                        ...
                                        <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up"
                                            ...
                                            <div class="position-relative px-4 pt-3 pb-2">
                                                <div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0 fs-12">{{ Auth::user()->names }} <span
                        ...
                        <nav class="sidebar-nav scroll-sidebar">
                            <div class="offcanvas-header justify-content-between">
                                <a href="template_premium/main/index.html" class="text-nowrap logo-img">
                                    <img src="{{ asset('template_premium/assets/images/logos/logo-icon.svg') }}"
                                        alt="Logo" />
                                </a>
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level my-3 ps-3">
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-chat.html"
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-invoice.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-contact2.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-email.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/page-user-profile.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-calendar.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                                        class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-contact.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                                        class="bg-secondary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            ...
                                            <li class="sidebar-item py-2">
                                                <a href="template_premium/main/app-notes.html"
                                                    class="d-flex align-items-center">
                                                    <div
                                                        class="bg-warning-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="position-relative">
                                            <div class="row">
                                                ...
                                                <div class="col-4 d-none d-lg-flex">
                                                    <img src="{{ asset('template_premium/assets/images/backgrounds/mega-dd-bg.jpg') }}"
                                ...
                                <ul
                                    ...
                                    <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                                        <a class="nav-link" href="javascript:void(0)" id="drop2"
                                            ...
                                            <img src="{{ asset('template_premium/assets/images/flag/icon-flag-en.svg') }}"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                            ...
                                            <div class="message-body">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('template_premium/assets/images/flag/icon-flag-cn.svg') }}"
                                                            alt="matdash-img" width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20" />
                                                    </div>
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('template_premium/assets/images/flag/icon-flag-fr.svg') }}"
                                                            alt="matdash-img" width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20" />
                                                    </div>
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('template_premium/assets/images/flag/icon-flag-sa.svg') }}"
                                                            alt="matdash-img" width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20" />
                                                    </div>
                    ...
                    <nav id="sidebarnavh" class="sidebar-nav scroll-sidebar container-fluid">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    <li class="sidebar-item">
                                        <a href="{{ asset('template_premium/main/index.html') }}"
                                            class="sidebar-link">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="template_premium/main/app-email.html"
                                            aria-expanded="false">
                                            <span>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/page-account-settings.html"
                                            class="sidebar-link">
                                            <i class="ti ti-user-circle"></i>
                                            <span class="hide-menu">Account Setting</span>
                                        </a>
                            ...
                            <li class="sidebar-item mega-dropdown">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/ui-tooltip-popover.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                                            <span class="hide-menu">Tooltip & Popover</span>
                                        </a>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/form-checkbox-radio.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/form-bootstrap-switch.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/form-row-separator.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                                            <span class="hide-menu">Row Separator</span>
                                        </a>
                                    ...
                                    <!-- Tinymce Editor -->
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/form-editor-tinymce.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="template_premium/main/table-datatable-api.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                                            <span class="hide-menu">API</span>
                                        </a>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="template_premium/main/icon-tabler.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link"
                                            href="template_premium/main/icon-solar.html" aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                            <span class="hide-menu">Solar Icon</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card rounded-2 overflow-hidden">
                        <div class="position-relative">
                            <a href="javascript:void(0)">
                                @php
                                    $image_1 = 'imageusers/' . $topic[0]->image_1;
                                @endphp
                                @if ($topic[0]->image_1 == '')
                                    <img src="{{ asset('ayba/proyecto_banner.png') }}"
                                        class="card-img-top rounded-0 object-fit-cover" alt="matdash-img"
                                        height="240">
                                @else
                                <img src="{{ asset($image_1) }}"
                                class="card-img-top rounded-0 object-fit-cover" alt="matdash-img"
                                height="240">
                                @endif
                            ...
                            <span class="badge text-bg-light mb-9 me-9 position-absolute bottom-0 end-0">
                                @php

                                    // Crear un objeto DateTime con la hora proporcionada
                                    $datetime = new DateTime($topic[0]->time);
                                @endphp
                                {{ $datetime->format('h:i ') }} hrs. </span>

                            <img src="{{ asset('template_premium/assets/images/profile/user-5.jpg') }}"
                                alt="matdash-img"
                        ...
                        <div class="card-body border-top p-4">
                            ...
                            @php
                                $resource_1 = "resource/".$topic[0]->resource_1;
                            @endphp
                            <div class="border-top mt-7 pt-7">
                                <h5 class="fw-semibold mb-2">Recursos</h5>
                                <div class="p-3 bg-light rounded border-start border-2 border-primary">
                                    <h6 class="mb-0 fs-4 fw-semibold">
                                        ...
                                        <a  style="color:rgb(18, 132, 185)"
                                         target="_blank" href="{{asset($resource_1)}}" download="{{ asset($topic[0]->resource_1) }}" >  {{ $topic[0]->resource_1 }}</a>
                            ...
                            @if ($topic[0]->file_1 != '')
                                @php
                                    $file_1 = 'file/' . $topic[0]->file_1;
                                @endphp
                                <h5>Documento 01</h5>
                                <iframe src="{{ asset($file_1) }}" width="100%" height="500px"></iframe>
                            @endif

                            @if ($topic[0]->file_2 != '')
                                @php
                                    $file_2 = 'file/' . $topic[0]->file_2;
                                @endphp
                                <h5>Documento 02</h5>
                                <iframe src="{{ asset($file_2) }}" width="100%" height="500px"></iframe>
                            @endif
